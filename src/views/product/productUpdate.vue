              ...
              <el-row>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" >
                  <!-- <el-tooltip class="item" effect="dark" content="将替换作者" placement="top"> -->
                    <el-form-item label-width="100px" label="商品名称:" class="postInfo-container-item" prop="goodsname">
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8">
                  <el-form-item label-width="100px" label="推荐类型:" class="postInfo-container-item" prop="sale_ty">
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8">
                  <el-form-item label-width="100px" label="商品价格:" class="postInfo-container-item" prop="price">
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8">
                  <el-form-item label-width="100px" label="商品库存:" class="postInfo-container-item" prop="stock">
                ...
                <el-col :xs="24" :sm="24" :md="16" :lg="16">
                  <el-form-item label-width="100px" label="商品状态:" class="postInfo-container-item" prop="status">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sale_ty: [{ required: true, message: '请输入推荐类型', trigger: 'blur' }],
